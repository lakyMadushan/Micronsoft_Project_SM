...
public class customer_register extends javax.swing.JFrame {
    ...
    public void inIDload() {
        try {
            ResultSet rs = DB.search("select id from cus_reg order by id desc");
            if (rs.next()) {
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from cus_reg ");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cus Contact No");
        ...
        jLabel8.setText("Cus Add");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel9.setText("Cus NIC");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cus ID", "Cus Name", "Contact No", "Cus NIC", "Cus Add"
            }
        ) {
        ...
        jLabel2.setText("SM | Customer Register");
        ...
        jRadioButton3.setText("Cus Name");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1069, Short.MAX_VALUE)
                            .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 1069, Short.MAX_VALUE)
    ...
    private void jTextField11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField11KeyReleased
        try {
            ...
            if (jRadioButton1.isSelected()) {
                ResultSet rs = DB.search("select * from cus_reg where tp like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    //if (rs.getString("p_num").equals(jTextField11.getText())) {
                    v1.add(rs.getString("id") + ":" + rs.getString("name") + "-" + rs.getString("tp") + "-" + rs.getString("nic") + "-" + rs.getString("address"));
            ...
            if (jRadioButton2.isSelected()) {
                ResultSet rs = DB.search("select * from cus_reg where id like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    //if (rs.getString("p_num").equals(jTextField11.getText())) {
                    v1.add(rs.getString("id") + ":" + rs.getString("name") + "-" + rs.getString("tp") + "-" + rs.getString("nic") + "-" + rs.getString("address"));
            ...
            if (jRadioButton3.isSelected()) {
                ResultSet rs = DB.search("select * from cus_reg where name like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    //if (rs.getString("p_num").equals(jTextField11.getText())) {
                    v1.add(rs.getString("id") + ":" + rs.getString("name") + "-" + rs.getString("tp") + "-" + rs.getString("nic") + "-" + rs.getString("address"));
            ...
            if (jTextField4.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from cus_reg where id = '" + jTextField1.getText() + "' ");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField4.getText().isEmpty()) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("update cus_reg set name = '" + jTextField2.getText() + "', tp = '" + jTextField3.getText() + "'"
                                    + ", nic = '" + jTextField4.getText() + "', address = '" + jTextField5.getText() + "' where id = '" + jTextField1.getText() + "' ");
            ...
            if (jTextField4.getText().isEmpty()) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        DB.iud("insert into cus_reg (name,tp,nic,address) "
                                + "values ('" + jTextField2.getText() + "','" + jTextField3.getText() + "','" + jTextField4.getText() + "','" + jTextField5.getText() + "')");
        ...
        if (jTextField4.getText().isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    DB.iud("insert into cus_reg (name,tp,nic,address) values ('" + jTextField2.getText() + "','" + jTextField3.getText() + "','" + jTextField4.getText() + "','" + jTextField5.getText() + "')");
    ...
    private void jTextField4KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyReleased
        if (Character.isDigit(evt.getKeyChar()) | Character.isLetter(evt.getKeyChar()) | evt.getKeyCode() == KeyEvent.VK_ENTER
                | evt.getKeyCode() == KeyEvent.VK_BACK_SPACE | evt.getKeyCode() == KeyEvent.VK_DELETE | evt.getKeyCode() == KeyEvent.VK_SHIFT
