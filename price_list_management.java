 ...
 */
public class price_list_management extends javax.swing.JFrame {
    ...
    /**
     * Creates new form price_list_management
     */
    public price_list_management() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SM | Price List Management");

        jPanel2.setBackground(new java.awt.Color(204, 204, 255));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("Price List Name");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "P L  ID", "P L Name", "P L ID", "Item ID", "Item Name", "Size", "Cost", "Selling Price"
            }
        ) {
        ...
        jMenuItem1.setText("Price List Saving");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField7.getText().equals("")) {
            try {
                ...
                String item = jTextField2.getText() + "-" + jTextField3.getText();
                DB.iud("insert into price_l_manage (p_l_name,p_l_id,item_id,item_name,size,cost,sell_price) values ( "
                        + "'" + jComboBox1.getSelectedItem() + "' , '" + jTextField2.getText() + "' ,'" + item + "','" + jTextField4.getText() + "' ,'" + jTextField5.getText() + "',"
            ...
            if (jTextField2.getText().equals("") || jTextField3.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update price_l_manage set p_l_name = '" + jComboBox1.getSelectedItem() + "',p_l_id = '" + jTextField2.getText() + "',item_id = '" + jTextField3.getText() + "',"
                                + "item_name = '" + jTextField4.getText() + "',size = '" + jTextField5.getText() + "',cost = '" + jTextField6.getText() + "',sell_price = '" + jTextField7.getText() + "'"
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField3.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from price_l_manage where id = '" + jTextField1.getText() + "' ");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            ...
            if (selectedItem != null) {
                ResultSet rs = DB.search("SELECT * FROM price_l_save WHERE name = '" + jComboBox1.getSelectedItem().toString() + "'");
                if (rs.next()) {
                    jTextField2.setText(rs.getString("p_l_n_id"));
                } else {
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        if (jTextField3.getText().equals("")) {
            jTextField3.grabFocus();
            JOptionPane.showMessageDialog(this, " Enter Item Id !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField6FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField6FocusGained
        if (jTextField5.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(this, " Enter Item Price !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String p_l_name = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    String p_l_id = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
                    String i_id = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
                    String i_name = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();
                    String size = dtm.getValueAt(jTable1.getSelectedRow(), 5).toString();
                    String i_cost = dtm.getValueAt(jTable1.getSelectedRow(), 6).toString();
                    String i_sellP = dtm.getValueAt(jTable1.getSelectedRow(), 7).toString();

                    jTextField1.setText(id);
                    jComboBox1.setSelectedItem(p_l_name);
                    jTextField2.setText(p_l_id);
                    jTextField3.setText(i_id);
                    jTextField4.setText(i_name);
                    jTextField5.setText(size);
                    jTextField6.setText(i_cost);
                    jTextField7.setText(i_sellP);
    ...
    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        if (Character.isLetter(evt.getKeyChar()) |Character.isDigit(evt.getKeyChar()) | evt.getKeyCode() == KeyEvent.VK_ENTER
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(price_list_management.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new price_list_management().setVisible(true);
            }
        });
    }
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from price_l_manage order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from price_l_manage order by id ASC");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("p_l_name"));
                v.add(rs.getString("p_l_id"));
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from price_l_manage where id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("p_l_name"));
    ...
    private void p_L_S_Com() {
        try {
            jComboBox1.removeAllItems();
            ResultSet rs = DB.search("select * from price_l_save order by name");
            while (rs.next()) {
