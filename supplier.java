...
public class supplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SM | Supplier Saving");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S ID", "Supplier Name", "Phone", "Nic", "Credit Amount"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField2.getText().equals("")) {
            try {
                ...
                DB.iud("insert into supplier (name,phone,nic,c_a) values ( '" + jTextField2.getText() + "' ,'" + jTextField3.getText() + "','" + jTextField4.getText() + "' ,'" + 0.0 + "' )");
            ...
            if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update supplier set name = '" + jTextField2.getText() + "',phone = '" + jTextField3.getText() + "',nic = '" + jTextField4.getText() + "' where id = '" + jTextField1.getText() + "' ");
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        if (jTextField2.getText().equals("")) {
            jTextField2.grabFocus();
            JOptionPane.showMessageDialog(this, " Enter Name !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        if (jTextField3.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(this, " Enter Phone !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField4ActionPerformed
        if (jTextField4.getText().length() == 10 || jTextField4.getText().length() == 12) {
            jButton1.grabFocus();
        } else {
            JOptionPane.showMessageDialog(this, "Must enter 10 or 12 numbers", "ERROR!", JOptionPane.ERROR_MESSAGE, erricon);
        }
