 ...
 */
public class aditional_service_charges extends javax.swing.JFrame {
    ...
    /**
     * Creates new form aditional_service_charges
     */
    public aditional_service_charges() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SM | Additional Service Charges");

        jPanel2.setBackground(new java.awt.Color(204, 204, 255));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("A ID");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "A ID", "Service Name", "Cost", "Charge", "Remark"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField5.getText().equals("")) {
            try {
                ...
                DB.iud("insert into ad_se_charge (a_id,s_name,price,cost,remark) values ( '" + jTextField1.getText() + "' ,'" + jTextField2.getText() + "',"
            ...
            if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update ad_se_charge set s_name = '" + jTextField2.getText() + "',price = '" + jTextField3.getText() + "',"
                                + "cost = '" + jTextField4.getText() + "',remark = '" + jTextField5.getText() + "' where a_id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField2.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from ad_se_charge where a_id = '" + jTextField1.getText() + "' ");
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        if (jTextField2.getText().equals("")) {
            jTextField2.grabFocus();
            JOptionPane.showMessageDialog(this, " Enter Service Name !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        if (jTextField3.getText().equals("")) {
            jTextField3.grabFocus();
            JOptionPane.showMessageDialog(this, " Enter Service Cost !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField5FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField5FocusGained
        if (jTextField4.getText().equals("")) {
            jTextField4.grabFocus();
            JOptionPane.showMessageDialog(this, " Enter Service Charge !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String cost = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
                    String charge = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
                    String remark = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();

                    jTextField1.setText(id);
                    jTextField2.setText(name);
                    jTextField3.setText(cost);
                    jTextField4.setText(charge);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aditional_service_charges.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aditional_service_charges().setVisible(true);
            }
        });
    }
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from ad_se_charge order by id DESC");
            if (rs.next()) {
                jTextField1.setText("0" + String.valueOf(Integer.parseInt(rs.getString("id")) + 1));
            } else {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from ad_se_charge order by a_id ASC");
            while (rs.next()) {
...
//                v.add(rs.getString("time"));
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from ad_se_charge where a_id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("a_id"));
                v.add(rs.getString("s_name"));
