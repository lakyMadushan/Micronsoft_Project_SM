 ...
 */
public class catagory_2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField2.getText().equals("")) {
            try {
                ...
                DB.iud("insert into ca_2 (name) values ( '" + jTextField2.getText() + "' )");
            ...
            if (jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update ca_2 set name = '" + jTextField2.getText() + "' where id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField2.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from ca_2 where id = '" + jTextField1.getText() + "' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catagory_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from ca_2 order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from ca_2 order by id ASC");
            while (rs.next()) {
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from ca_2 where id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("name"));
