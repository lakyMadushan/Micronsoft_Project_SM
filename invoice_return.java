 ...
 * @author DELL
 */
public class invoice_return extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Date", "Time", "Item ID", "Item Name", "Unit Price Rs.", "Sell Price Rs.", "Qty", "Amount Rs."
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class
            };
        ...
        jLabel2.setText("WM | Invoice Return");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 982, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        try {
            ...
            if (rs1.next()) {
                if (rs1.getString("id").equals(jLabel11.getText())) {
                    ...
                    jTextField15.setText(prt2[0]);
                    jTextField16.setText(prt2[1]);
                    jTextField17.setText(prt2[2]);
                    jTextField19.setText(prt2[3]);
                    jTextField24.setText(prt2[4]);
                    jTextField25.setText(prt2[5]);
                    jTextField22.setText(prt2[6]);
                    jTextField23.setText(prt2[7]);
                    jTextField1.setText(prt2[8]);
                    jTextField2.setText(prt2[9]);
                    jTextField3.setText(prt2[10]);
                    jTextField10.setText(prt2[11]);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        jLabel9.setText(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
...
//        }
            ...
            if (jTextField12.getText().isEmpty()) {
                ...
                if (jRadioButton4.isSelected()) {
                    ...
                    while (rs.next()) {
                        ...
                        v1.add(rs.getString("id") + ":" + rs.getString("s_total") + "/" + rs.getString("dis") + "/" + rs.getString("less") + "/" + rs.getString("net_t")
    ...
    private void jTextField11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField11ActionPerformed
        if (jTextField9.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Select Item", "ERROR!", JOptionPane.ERROR_MESSAGE, erricon);
            jTextField9.setText("");
            jTable1.grabFocus();
        } else {
            try {
                ResultSet rs = DB.search("select * from invoice_item where id = '" + jLabel9.getText() + "'");

                while (rs.next()) {
                    double a = Double.valueOf(rs.getString("qty"));
                    double b = Double.valueOf(jTextField11.getText());

                    if (b <= a) {
                        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();

                        double q1 = Double.valueOf(jTextField9.getText());
                        double q2 = Double.valueOf(jTextField11.getText());
                        double q3 = Math.round((q1 - q2) * 100.0) / 100.0;
                        //double qty = Double.valueOf(jTextField9.getText());
                        double sell = Double.valueOf(jTextField8.getText());
                        double sps = Math.round((q3 * sell) * 100.0) / 100.0;

                        double uni = Double.valueOf(jTextField7.getText());
                        double bps = Math.round((q3 * uni) * 100.0) / 100.0;
                        double profit = Math.round((sps - bps) * 100.0) / 100.0;

                        DB.iud("update invoice_item set qty = '" + String.valueOf(q3) + "', sps = '" + String.valueOf(sps) + "'"
                                + ", bps = '" + String.valueOf(bps) + "', profit = '" + String.valueOf(profit) + "' where id = '" + jLabel9.getText() + "' ");

                        tableload();
                        DB.iud("insert into invoice_re_item (date,time,in_id,item_id,item_name,re_qty,cus_id,cus_name,cus_tp,cus_nic) "
                                + "values ('" + jLabel3.getText() + "','" + jLabel1.getText() + "','" + jLabel11.getText() + "',"
                                + "'" + jTextField5.getText() + "','" + jTextField6.getText() + "','" + jTextField11.getText() + "'"
                                + ",'" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jTextField3.getText() + "'"
                                + ",'" + jTextField10.getText() + "')");

                        double sum1 = 0;
                        for (int i = 0; i < dtm.getRowCount(); i++) {
                            sum1 = sum1 + Double.parseDouble(dtm.getValueAt(i, 8).toString());
                            jTextField15.setText(String.valueOf(sum1));
                            jTextField19.setText(String.valueOf(sum1));
                        }

                        double dis = Double.parseDouble(jTextField16.getText()) / 100;
                        double tot = Double.parseDouble(jTextField15.getText());
                        double sumdis = Math.round((dis * tot) * 100.0) / 100.0;
                        jTextField17.setText(String.valueOf(sumdis));

                        double s2 = Double.parseDouble(jTextField17.getText());
                        double sub = Double.parseDouble(jTextField15.getText());
                        double sum = Math.round((sub - s2) * 100.0) / 100.0;;
                        jTextField19.setText(String.valueOf(sum));

                        double net = Double.parseDouble(jTextField19.getText());
                        double add = Double.parseDouble(jTextField24.getText());
                        double sum2 = Math.round((net - add) * 100.0) / 100.0;
                        jTextField25.setText(String.valueOf(sum2));

                        DB.iud("update invoice set s_total = '" + jTextField15.getText() + "', net_t = '" + String.valueOf(net) + "'"
                                + ", less = '" + jTextField17.getText() + "',balance = '" + jTextField25.getText() + "' where id = '" + jLabel11.getText() + "' ");

                        JOptionPane.showMessageDialog(this, "Update and Add Successfully!", "DONE", JOptionPane.INFORMATION_MESSAGE, icon);
                        ...
                        JOptionPane.showMessageDialog(this, "Please Not Enough Quantity", "ERROR!", JOptionPane.ERROR_MESSAGE, erricon);
                        jTextField11.setText("");
                        jTextField11.grabFocus();
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new invoice_return().setVisible(true);
            }
        });
    }
